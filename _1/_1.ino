...
void S_3501()
{
  ...
  if (FSM1.getTime() > 650) FSM1.transit(S_3502);
}
//------------------------------------
void S_3502()
{
...
void S_4101()
{
  ...
  if (S2.getHiLow() == WHT && S4.getHiLow() == WHT) FSM1.transit(S_4102);
...
void S_4102()
{
  if (FSM1.doTask())
  {
    LEDDisplay.setValue(4102);
    MotorR.setSpeed(NORMAL_SPEED - RIGHT_OFFSET);
    MotorL.setSpeed(NORMAL_SPEED - LEFT_OFFSET);
  }
  if (!(S2.getHiLow() == WHT && S4.getHiLow() == WHT)) FSM1.transit(S_4101);
}
//------------------------------------
void S_4103()
{
...
void S_4501()
{
  ...
  if (FSM1.getTime() > 650) FSM1.transit(S_4502);
}
//------------------------------------
void S_4502()
{
